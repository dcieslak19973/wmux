export const WORKSPACE_THEMES = [
  {
    ...
    xterm: {
      ...
      black: '#1a1b1e', red: '#f87171', green: '#3f8f68',
      yellow: '#fbbf24', blue: '#9bbcff', magenta: '#c084fc',
      cyan: '#22d3ee', white: '#e4e4e7',
      brightBlack: '#3f3f46', brightRed: '#fca5a5', brightGreen: '#79c79a',
      brightYellow: '#fde68a', brightBlue: '#c3d7ff', brightMagenta: '#d8b4fe',
  ...
  },
  {
    ...
    xterm: {
      ...
      black: '#111714', red: '#f87171', green: '#488d67',
      yellow: '#facc15', blue: '#9fc2ff', magenta: '#a78bfa',
      cyan: '#2dd4bf', white: '#e6f3eb',
      brightBlack: '#385045', brightRed: '#fca5a5', brightGreen: '#76c298',
      brightYellow: '#fde047', brightBlue: '#c8dcff', brightMagenta: '#c4b5fd',
  ...
  },
  {
    ...
    xterm: {
      ...
      black: '#1b1412', red: '#fb7185', green: '#3f9b7b',
      yellow: '#fbbf24', blue: '#98bfff', magenta: '#f0abfc',
      cyan: '#22d3ee', white: '#f5ebe6',
      brightBlack: '#594038', brightRed: '#fda4af', brightGreen: '#79cfa9',
      brightYellow: '#fcd34d', brightBlue: '#c7defe', brightMagenta: '#f5d0fe',
  ...
  },
  {
    ...
    xterm: {
      ...
      black: '#101722', red: '#f87171', green: '#3b9a6d',
      yellow: '#facc15', blue: '#9fc0ff', magenta: '#c084fc',
      cyan: '#38bdf8', white: '#e5f0ff',
      brightBlack: '#334155', brightRed: '#fca5a5', brightGreen: '#72c69a',
      brightYellow: '#fde047', brightBlue: '#c6dbff', brightMagenta: '#d8b4fe',
